...
const envSchema = z.object({
  ...
  NEAR_TELEGRAM_BOT_TOKEN: z.string().default(""),
  NEAR_TELEGRAM_CHAT_ID: z.string().default(""),
...
function readEnv(env: NodeJS.ProcessEnv) {
  return {
    ...
    NEAR_TELEGRAM_BOT_TOKEN: env.NEAR_TELEGRAM_BOT_TOKEN,
    NEAR_TELEGRAM_CHAT_ID: env.NEAR_TELEGRAM_CHAT_ID,
