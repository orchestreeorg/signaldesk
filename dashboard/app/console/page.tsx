...
export default function ConsolePage() {
  ...
  return (
    <AppShell
      current="console"
      title="Console"
      subtitle="Live worker log: fetches, skips, holds, sends, and idle waits. This is not a trading UI."
      extra={
        <StatusChip
          online={online}
          paused={Boolean(heartbeat?.paused)}
          label={online ? (heartbeat?.paused ? "paused" : `online pid ${heartbeat?.pid}`) : "offline"}
        />
      }
    >
